"use client";
import Combobox from "@/app/components/controls/ComboBox";
...
export default function Example() {
  ...
  return (
    <CardPrototype className="mt-5 px-2">
      <form>
        <div className="space-y-12">
            ...
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div className="mt-2">
                  <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                    ...
                    <input
                      ...
                      className="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-muted-foreground placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
              ...
              <div className="col-span-full">
                ...
                <div className="mt-2">
                  <textarea
                    ...
                    name="about"
                    rows={3}
                    className="block w-full rounded-md border-0 py-1.5 text-muted-foreground shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    defaultValue={""}
                  />
                </div>
              ...
              <div className="col-span-full">
                ...
                <div className="mt-2 flex items-center gap-x-3">
                  ...
                  <button
                    type="button"
                    className="rounded-md bg-white px-2.5 py-1.5 text-sm font-semibold text-muted-foreground shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50"
                  >
                    Change
                  </button>
                </div>
          ...
          <div className="border-b border-gray-900/10 pb-12">
            ...
            <div className="mt-10 space-y-10">
              <fieldset>
                <legend className="text-sm font-semibold leading-6 text-muted-foreground">
                  By Email
                </legend>
