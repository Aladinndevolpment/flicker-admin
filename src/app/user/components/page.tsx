  ...
  return (
    <div className="flex flex-wrap overflow-x-hidden md:-mx-1 py-3 gap-y-2">
      <div className="w-full md:w-1/3 md:px-2">
        <CardPrototype>
          <h2 className="text-xl text-primary mb-3">Dialog</h2>
          <AlertDialog>
      ...
      <div className="w-full md:w-1/3 md:px-2">
        <CardPrototype>
          <h2 className="text-xl text-primary mb-3">Hover Card</h2>
          <HoverCard>
            ...
            <HoverCardContent className="w-80">
              <div className="flex justify-between space-x-4">
                <Avatar>
                  <Image
                    src={JSON.stringify(AppAssets.avatar)}
                    alt="Avatar"
      ...
      <div className="w-full md:w-1/3 md:px-2">
        <CardPrototype>
          <h2 className="text-xl text-primary mb-3">Sheet</h2>
      ...
      <div className="w-full md:w-1/3 md:px-2">
        <CardPrototype>
          <h2 className="text-xl text-primary mb-3">Menu bar</h2>
          <Menubar>
            <MenubarMenu>
