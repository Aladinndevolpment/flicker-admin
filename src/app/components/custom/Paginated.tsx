            ...
            {pageNumbers.map((pageNumber, index) => {
              if (index < 3 || index >= numberOfPages - 3) {
                  ...
                  <a
                    ...
                    className={`relative inline-flex items-center px-4 py-2 text-sm font-semibold ${
                      pageNumber === 1
                        ...
                        : "text-muted-foreground ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0"
                    }`}
                  >
                    {pageNumber}
                  </a>
                ...
                return (
                  <span
                    key="ellipsis-start"
                    className="relative inline-flex items-center px-4 py-2 text-sm font-semibold text-muted-foreground ring-1 ring-inset ring-gray-300 focus:outline-offset-0"
                  >
                    ...
                  </span>
                );
